		...
		new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					parse("weibo_sina_code.json", QQ_ERRS);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}

			protected void parse(String string, HashMap<Integer, String> errorMap) throws Exception {
				JSONObject json = new JSONObject(Utils.loadAssetsText(context, "weibo_sina_code.json"));
